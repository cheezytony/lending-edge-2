<template>
  <article>
    ...
    <section class="page-banner-area page-contact" id="page-banner">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 m-auto text-center col-sm-12 col-md-12">
            <div class="banner-content content-padding">
              <h1 class="text-white">LENDING EDGE</h1>
              <p>
                Lending Edge Limited is an online Loan Firm created to make life
                easy for the people by helping them meet their urgent Financial needs.
                Entry into the Market, Lending Edge Finance will bring change by making
                flexible loans quick no matter the time of the day the loan is requested.
                No matter what you do (Personal business or Salary earner) in life
                to make ends meet, we are ready to render our service to you without delay.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 col-sm-12 col-md-8 mb-4">
            ...
            <p class="mb-4">
              ...
              looking for a partner for their digital media, design-dev, lead generation
            </p>
            ...
            <ul class="about-list2 my-4">
              <li class="mb-2">
                ...
                Best Analytics Audits to your site in specific niche
              </li>

              <li class="mb-2">
                <i class="icofont icofont-check-circled"></i>
                Modern Keyword Analysis to keep up to date
              </li>

              <li class="mb-2">
                <i class="icofont icofont-check-circled"></i>
                More quality content, social networking and relative sharing
              </li>

              <li class="mb-2">
                <i class="icofont icofont-check-circled"></i>
                Social networking and relative sharing More quality content,
              </li>
            </ul>
        ...
        <div class="row">
          <div class="col-lg-6 ">
            <div class="media img-block mb-3 mb-lg-0">
              <img
                src="images/about/h-1.jpg"
                alt=""
                class="img-fluid rounded mr-3"
              />
              <div class="media-body ">
                <h4 class="mb-3">
                  Provide services with maintain quality from 24 years!
                </h4>
                <p>
                  We provide marketing services to startups.Let's start your site in grow high.
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="media img-block">
              <img
                src="images/about/h-2.jpg"
                alt=""
                class="img-fluid rounded mr-3"
              />
              <div class="media-body">
                <h4 class="mb-3">
                  Our mission is to provide our client what they need!
                </h4>
                <p>
                  We provide small businesses looking for a partner for their digital media
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="row">
              <div class="col-lg-6">
                <div class="mb-5">
                  <span class="icon-3x text-default">
